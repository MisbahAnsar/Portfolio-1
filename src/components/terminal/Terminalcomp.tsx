    ...
    const processCommand = async (e: KeyboardEvent<HTMLInputElement>) => {
        ...
        switch (command) {
            ...
            case "cat .open_me":
                ...
                break;
            case "misbah":
                output = "Hello there! I am Misbah, a Full Stack Developer experienced in the MERN stack, currently pursuing my Bachelor's  in Computer Science and Engineering. Type about to know more about me";
                break;
            case "neofetch":
            ...
            case "help":
                ...
                break;
            case "keizerr":
                window.location.href = "https://keizerr.netlify.app";
                output = "";
                break;
            case "bookify":
                window.location.href = "https://bookify-peach.vercel.app";
                output = "";
                break;
            case "1000xdevs":
                // window.location.href = "https://bookify-peach.vercel.app";  // add ur link here
                output = "coming sooooon~";
                break;
            case "blog-zer":
                // window.location.href = "https://bookify-peach.vercel.app";  add ur link here
                output = "coming sooooon~";
